...
const Button = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 transition-transform duration-1000 ease-out -translate-x-full skew-x-12 -top-2 -bottom-2 bg-linear-to-r from-transparent via-white/20 to-transparent group-hover:translate-x-full" />
    </button>
  );
};
        ...
        <div className="px-6 mx-auto max-w-7xl lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              <span className="text-xl font-bold text-white">GWL</span>
            </div>
          </div>
        </div>
      </nav>
      ...
      <div className="relative z-10 flex min-h-[calc(100vh-4rem)] items-center">
        <div className="px-6 mx-auto max-w-7xl lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            {/* Badge */}
            <div className="inline-flex items-center px-4 py-2 mb-8 text-sm border rounded-full bg-white/5 backdrop-blur-xl border-white/10 text-white/90">
              <Star className="w-4 h-4 mr-2 text-white" />
              {"Built for GWL attendance tracking"}
            </div>

            {/* Main Heading */}
            <h1 className="mb-6 text-4xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl">
              Keep GWL check-ins{" "}
              <span className="text-transparent bg-linear-to-r from-white via-gray-200 to-gray-400 bg-clip-text">
                accurate
              </span>{" "}
              and
              <br />
            ...
            {/* Subtitle */}
            <p className="max-w-3xl mx-auto mb-10 text-lg leading-8 text-white/80 sm:text-xl lg:text-2xl">
              Sign in quickly, administrators verify attendance in one place,
              and your records stay organized for each day.
            </p>
            ...
            <div className="flex flex-col items-center justify-center gap-4 mb-12 sm:flex-row">
              <Button
                size="lg"
                className="font-semibold shadow-2xl shadow-white/25"
                onClick={() =>
                  router.push(
            ...
            <div className="grid max-w-2xl grid-cols-1 gap-8 mx-auto sm:grid-cols-3">
              <div className="text-center">
                ...
                <div className="text-sm text-white/60">Attendance history</div>
              </div>
              <div className="text-center">
                <div className="mb-2 text-3xl font-bold text-white">Fast</div>
                <div className="text-sm text-white/60">
                  Location verification
                </div>
              </div>
              <div className="text-center">
                <div className="mb-2 text-3xl font-bold text-white">Clear</div>
                <div className="text-sm text-white/60">
